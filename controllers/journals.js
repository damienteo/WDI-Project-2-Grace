        ...
        userAuthentication(
            ...
            (authentication) => {
                db.journals.newJournal(templateChoice, currentUserId, (journals) => {
                    response.render('entries/NewJournal', {
                        journals,
                        authentication
                    });
                });
        ...
        userAuthentication(
            ...
            (authentication) => {
                db.journals.randomJournal((journals) => {
                    response.render('entries/RandomJournal', {
                        journals,
                        authentication
                    });
                });
        ...
        userAuthentication(
            ...
            (authentication) => {
                db.journals.complete(object, reason, template_id, currentUserId, (results) => {
                    ...
                    response.render('entries/PastJournals', {
                        results,
                        authentication
                    });
                });
        ...
        userAuthentication(
            ...
            (authentication) => {
                db.journals.editEntry(entryChoice, (results) => {
                    response.render('entries/EditJournal', {
                        results,
                        authentication
                    });
                });
        ...
        userAuthentication(
            ...
            (authentication) => {
                db.journals.editedEntry(entryChoice, object, reason, (results) => {
                    ...
                    let message = {
                        message: "You have edited the following post"
                    };

                    info.push(message);
                    info.push(results);

                    response.render('entries/LatestJournal', {
                        info,
                        authentication
                    });
                });
        ...
        userAuthentication(
            ...
            (authentication) => {
                db.journals.customise(currentUserId, (results) => {
                    response.render('entries/Customise', {
                        results,
                        authentication
                    });
                });
